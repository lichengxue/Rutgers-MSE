...
# Loop through the sensitivity analysis dataframe
for(i in 1:nrow(sens_analysis_settings)) {
  ...
  ##### MODEL 1 - Assumes gaussian relationship #####
  ...
  ##### MODEL 2 - Assumes to relationship between 
  # Execute the MSE loop for one realization
  ...
  ##### MODEL 3 - NO RELATIONSHIP BETWEEN TEMPERATURE AND RECRUITMENT #####
  ecov_em1 <- ecov_em
