...
#### COMPARE SSB BETWEEN MODELS ####
plot(mod1$om$rep$SSB, type = "l")
...
# Difference between linear ecov relationship parameter
...
# Next step is to generate catch advise between the models and see how they perform...