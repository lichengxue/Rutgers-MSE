...
3.  \(w_{\text{opt}} = \{0.1, 1, 5\}\) where 0.1 is an extremely narrow temperature response curve and 5 is very generous and will give good recruitment responses even to temperatures far from optimal value.
