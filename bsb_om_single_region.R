...
# logistic-normal-miss0 -> Logistic normal
# logistic-normal-ar1-miss0 -> Logistic normal with AR1
# multinomial - Multinomial
# Reference here for equations - Appendix B in Stock & Miller, Fisheries Research (2021)
...
##### Ecov_3 model #####
# NOTE: THIS IS WHAT WE ARE GOING TO USE AS THE BASE MODEL
